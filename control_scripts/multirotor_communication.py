...
class Communication:
    ...
    def __init__(self, vehicle_type, vehicle_id):
        ...
        self.cmd_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd",String,self.cmd_callback)
        self.cmd_pose_flu_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd_pose_flu", Pose, self.cmd_pose_flu_callback)
        self.offboard_cmd_pose_sub = rospy.Subscriber(self.vehicle_type+'_'+self.vehicle_id+"/command/pose", PoseStamped, self.offboard_cmd_pose_callback)

        self.cmd_pose_enu_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd_pose_enu", Pose, self.cmd_pose_enu_callback)
        self.cmd_vel_flu_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd_vel_flu", Twist, self.cmd_vel_flu_callback)
        self.cmd_vel_enu_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd_vel_enu", Twist, self.cmd_vel_enu_callback)
        self.cmd_accel_flu_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd_accel_flu", Twist, self.cmd_accel_flu_callback)
        self.cmd_accel_enu_sub = rospy.Subscriber( self.vehicle_type+'_'+self.vehicle_id+"/cmd_accel_enu", Twist, self.cmd_accel_enu_callback)
        ...
        self.in_air= rospy.Service(self.vehicle_type+'_'+self.vehicle_id+'/engage',Empty,self.takeoff_handler)
